...
function Keyboard({keyCode, isShift}: IProps): JSX.Element {

  // Svg 이용으로 인해 하위 컴포넌트를 생성하지 못함.
  // 한 컴포넌트 안에서 해결하는 방식으로 작성.
/*  useEffect(() => {
    if (keyCode) {
      let elements = Array.from(document.querySelectorAll('.layout > rect'))
      elements.map(item => {
        item.classList.remove('next-key')
      })
      let found = elements.find((element) => {
        return Number(element.dataset.keyCode) === keyCode
      })
      found?.classList.add('next-key')
    }
  }, [keyCode])*/
  ...
  useEffect(() => {
    if (keyCode) {
      let elements = Array.from(document.querySelectorAll('[data-key-code]'))
      elements.map((element) => {
        if (Number((element as HTMLElement).dataset.keyCode) === keyCode) {
    ...
    <div className="keyboard">
      <svg width="805" height="280" viewBox="0 0 805 280" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g className="layout">
          ...
          <rect data-key-code={192} x="10.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={49} x="65.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={50} x="120.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={51} x="175.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={52} x="230.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={53} x="285.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={54} x="340.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={55} x="395.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={56} x="450.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={57} x="505.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={48} x="560.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={189} x="615.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={187} x="670.5" y="10.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={8} x="725.5" y="10.5" width="69" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>

          <rect data-key-code={9} x="10.5" y="63.5" width="69" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={81} x="87.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={87} x="142.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={69} x="197.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={82} x="252.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={84} x="307.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={89} x="362.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={85} x="417.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={73} x="472.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={79} x="527.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={80} x="582.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={219} x="637.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={221} x="692.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={220} x="747.5" y="63.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>

          <rect data-key-code={20} x="10.5" y="116.5" width="82" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={65} x="100.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={83} x="155.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={68} x="210.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={70} x="265.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={71} x="320.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={72} x="375.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={74} x="430.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={75} x="485.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={76} x="540.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={186} x="595.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={222} x="650.5" y="116.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={13} x="705.5" y="116.5" width="89" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>

          <rect data-key-code={16} className={isShiftKey} x="10.5" y="169.5" width="114" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={90} x="132.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={88} x="187.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={67} x="242.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={86} x="297.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={66} x="352.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={78} x="407.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={77} x="462.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={188} x="517.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={190} x="572.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={191} x="627.5" y="169.5" width="47" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={16} className={isShiftKey} x="682.5" y="169.5" width="112" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>

          <rect data-key-code={17} x="10.5" y="222.5" width="59" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={18} x="77.5" y="222.5" width="59" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={32} x="144.5" y="222.5" width="516" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={21} x="668.5" y="222.5" width="59" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
          <rect data-key-code={25} x="735.5" y="222.5" width="59" height="47" rx="3.5" fill="white" stroke="#ACB0B8"/>
        </g>
        <g className="letter">
